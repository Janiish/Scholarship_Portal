    ...
    <div className="page-enter py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 slide-up">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-2xl font-bold text-white text-glow">Admin Dashboard</h1>
            </div>
            <p className="text-slate-500 text-sm ml-[52px]">Review and manage scholarship applications.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {Object.entries(counts).map(([key, val], i) => (
            <button
              ...
              className={`p-4 rounded-xl text-left transition-all duration-400 ease-spring hover-lift hover-shine slide-up ${
                filter === key
                  ? `glass-strong bg-gradient-to-br ${filterGlow[key]} ring-1 ring-white/10`
        ...
        {filtered.length === 0 ? (
          ...
          <div className="overflow-x-auto glass rounded-2xl hover-glow-ring slide-up delay-300">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            title="Approve"
                            className="p-2 rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-green-500/20 disabled:opacity-20 disabled:cursor-not-allowed disabled:hover:scale-100"
                          ...
                          <button
                            ...
                            title="Reject"
                            className="p-2 rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-red-500/20 disabled:opacity-20 disabled:cursor-not-allowed disabled:hover:scale-100"
